...
object Data {
  ...
  object PrivacyType {
    ...
    case object Public extends PrivacyType
    case object Private extends PrivacyType

    def fromString(s: String): PrivacyType = s match {
      case "public" => Public
      case "private" => Private
    }

    def asString(p: PrivacyType) = p match {
      case Public => "public"
      case Private => "private"
    }
  ...
  case class Document(id: String, privacyType: PrivacyType, name: String)
  ...
  object Operation {
    ...
    case class CreateDocument(name: String, privacy: PrivacyType) extends Operation
  ...
  implicit val pricacyTypeShows = Show.shows[PrivacyType](x => PrivacyType.asString(x))
